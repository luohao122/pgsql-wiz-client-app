...
import { addDataSource } from "./reducers/datasource.reducer.ts";

import { setLocalStorageItem } from "../../shared/utils/utils.ts";
import { DELETE_DATA_SOURCE } from "./graphql/datasource.ts";
import DataSourceGrid from "./components/datasource-list.tsx";

import AddDatasource from "./components/add-datasource.tsx";
import EditDatasource from "./components/edit-datasource.tsx";
...
const Datasource: FC = (): ReactElement => {
  const rootDatasource = useAppSelector((state: RootState) => state.datasource);
