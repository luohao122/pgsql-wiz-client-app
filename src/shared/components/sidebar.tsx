...
const Sidebar: FC = (): ReactElement => {
  ...
  return (
    <aside
      className={clsx(
        "h-screen bg-gray-800 text-white flex-shrink-0 transition-all duration-300 ease-in-out",
        {
          "w-64": !isCollapsed,
          "w-16": isCollapsed,
        }
    ...
    >
      <div className="p-4 flex justify-between items-center">
        ...
        <button
          ...
          className={clsx(
            "p-2 hover:bg-gray-700 rounded transition-transform duration-300",
            {
      ...
      <nav className="mt-4">
        <Link
          to="/dashboard"
          className={clsx(
            "flex gap-3 items-center p-4 hover:bg-gray-700 transition-all duration-300",
            {
